    ...
    (function (Routing) {
        ...
        function handleNavigation(data) {
            ...
            if (nextRoute) {
                ...
                nextView.prepareForRender("Page" + Date.now()).then(function () {
                    if (activeView) {
...
(function (Frost) {
    ...
    var View = (function () {
        ...
        View.prototype.prepareForRender = function (pageId) {
            var _this = this;
        ...
        function Section(pageId) {
            ...
            this.events = {
                ...
                sub: function (name, callback) {
                    name = _this.pageId + name;
                    _this.events.eventNames.push(name);
                ...
                unsubAll: function () {
                    _this.events.eventNames.forEach(function (name) {
                        Frost.Events.unsubscribeAll(name);
                    });
                    _this.events.eventNames = [];
                }
            };
            this.pageId = pageId;
        }
